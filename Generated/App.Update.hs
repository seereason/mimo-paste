...
instance Updatable App Paste'
    where updForm = \x -> (\(Just (Paste' _a₁
                                          ...
                                          _a₅
                                          _a₆)) -> (ul :: AppForm Paste' ->
                                                          AppForm Paste') <$> (\a1 a2 a3 a4 a5 a6 -> ((((fmap (\a1 a2 a3 a4 a5 a6 -> ((((fmap Paste' a1 <*> a2) <*> a3) <*> a4) <*> a5) <*> a6) a1 <*> a2) <*> a3) <*> a4) <*> a5) <*> a6) ((pure . (\x -> fmap (const (fromMaybe (error ("fromJust at " ++ show (Loc "" "" "" (0,
                                                                                                                                                                                                                                                                                                                                0) (0,
